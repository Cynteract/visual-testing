...
from robot.utils import assert_image, click_image, screenshot
...
class LoginTest:
    ...
    async def runTest(self, username: str, password: str, test_id: str):
        ...
        await click_image(self.app, IMGDIR / "Game_center.png", timeout=15)
        await assert_image(self.app, IMGDIR / "Please_connect.png", timeout=15)
